...
const CATEGORY_SEMANTICS: Record<string, { fr: string[]; de: string[]; en: string[]; keywords: string[] }> = {
  'Loyer':       { fr: ['Loyer', 'Bail', 'Location immobilière'], de: ['Miete', 'Pacht', 'Mietvertrag'], en: ['Rent', 'Lease', 'Property'], keywords: ['loyer', 'bail', 'miete', 'pacht', 'rent', 'lease', 'immobilier'] },
  'Assurance':   { fr: ['Assurance', 'Prévoyance', 'Mutuelle', 'Caisse maladie'], de: ['Versicherung', 'Vorsorge', 'Krankenkasse'], en: ['Insurance', 'Coverage', 'Policy'], keywords: ['assurance', 'versicherung', 'insurance', 'police', 'prämie', 'prime', 'franchise', 'sinistre', 'axa', 'allianz', 'zurich', 'helvetia', 'css', 'swica', 'helsana', 'concordia'] },
  'Télécom':     { fr: ['Télécom', 'Téléphone', 'Internet', 'Mobile', 'Fibre'], de: ['Telekommunikation', 'Mobilfunk', 'Internet', 'Telefon'], en: ['Telecom', 'Phone', 'Internet', 'Mobile', 'Broadband'], keywords: ['swisscom', 'sunrise', 'salt', 'orange', 'sfr', 'bouygues', 'free', 'telekom', 'internet', 'mobile', 'fiber', 'fibre', 'natel', 'handy', 'abo'] },
  'Fournitures': { fr: ['Fournitures', 'Matériel de bureau', 'Consommables', 'Papeterie'], de: ['Büromaterial', 'Bürobedarf', 'Zubehör', 'Verbrauchsmaterial'], en: ['Supplies', 'Office supplies', 'Stationery', 'Consumables'], keywords: ['papier', 'toner', 'büro', 'office', 'fournitures', 'cartouche', 'stylo', 'classeur'] },
  'Transport':   { fr: ['Transport', 'Voyage', 'Déplacement', 'Billet', 'Parking'], de: ['Reise', 'Transport', 'Fahrt', 'Flug', 'Parkplatz'], en: ['Travel', 'Transport', 'Flight', 'Train', 'Parking'], keywords: ['sbb', 'cff', 'ffs', 'sncf', 'train', 'vol', 'flug', 'taxi', 'uber', 'bolt', 'parking', 'péage', 'autoroute', 'billet', 'ticket', 'easyjet', 'swiss', 'lufthansa'] },
  'Repas':       { fr: ['Repas', 'Restaurant', 'Restauration', 'Café'], de: ['Mahlzeiten', 'Verpflegung', 'Restaurant', 'Gastronomie'], en: ['Meals', 'Restaurant', 'Food', 'Dining', 'Catering'], keywords: ['restaurant', 'café', 'repas', 'menu', 'essen', 'traiteur', 'catering', 'pizz', 'sushi', 'brasserie', 'bistro'] },
  'Honoraires':  { fr: ['Honoraires', 'Frais professionnels', 'Cotisations', 'Abonnement', 'Conseil'], de: ['Gebühren', 'Honorar', 'Beitrag', 'Abonnement', 'Beratung'], en: ['Fees', 'Professional fees', 'Subscription', 'Consulting', 'Membership'], keywords: ['honoraires', 'gebühren', 'cotisation', 'beitrag', 'abonnement', 'subscription', 'conseil', 'beratung', 'fiduciaire', 'avocat', 'notaire', 'treuhänder', 'anwalt'] },
  'Énergie':     { fr: ['Énergie', 'Électricité', 'Gaz', 'Chauffage', 'Eau'], de: ['Energie', 'Strom', 'Gas', 'Heizung', 'Wasser'], en: ['Energy', 'Electricity', 'Gas', 'Heating', 'Water', 'Utilities'], keywords: ['kwh', 'électricité', 'strom', 'gas', 'ewz', 'romande', 'engie', 'edf', 'alpiq', 'bkw', 'iwb', 'chauffage', 'heizung', 'eau', 'wasser', 'sig'] },
  'Logiciels':   { fr: ['Logiciels', 'Abonnement SaaS', 'Licence', 'Hébergement'], de: ['Software', 'SaaS-Abonnement', 'Lizenz', 'Hosting'], en: ['Software', 'SaaS', 'License', 'Hosting', 'Cloud'], keywords: ['license', 'licence', 'saas', 'cloud', 'microsoft', 'google', 'adobe', 'github', 'aws', 'azure', 'heroku', 'vercel', 'netlify', 'dropbox', 'slack', 'notion', 'figma', 'jetbrains'] },
  'Administration':{ fr: ['Administration', 'Cotisations sociales', 'Taxes', 'Impôts', 'AVS', 'LPP'], de: ['Verwaltung', 'Sozialabgaben', 'Steuern', 'AHV', 'BVG'], en: ['Administration', 'Social contributions', 'Taxes', 'Government'], keywords: ['administration', 'verwaltung', 'cotisation', 'urssaf', 'avs', 'ahv', 'lpp', 'bvg', 'lamal', 'impôt', 'steuer', 'tax', 'commune', 'canton', 'gemeinde', 'centre patronal'] },
  'Santé':       { fr: ['Santé', 'Médecin', 'Pharmacie', 'Dentiste', 'Hôpital'], de: ['Gesundheit', 'Arzt', 'Apotheke', 'Zahnarzt', 'Spital'], en: ['Health', 'Medical', 'Pharmacy', 'Dentist', 'Hospital'], keywords: ['médecin', 'arzt', 'pharmacie', 'apotheke', 'dentiste', 'zahnarzt', 'hôpital', 'spital', 'ordonnance', 'rezept', 'consultation', 'analyse', 'labo'] },
  ...
  'Matériel':    { fr: ['Matériel informatique', 'Équipement', 'Machines'], de: ['Hardware', 'IT-Ausrüstung', 'Geräte', 'Maschinen'], en: ['Hardware', 'IT Equipment', 'Devices', 'Machines'], keywords: ['ordinateur', 'computer', 'laptop', 'monitor', 'bildschirm', 'écran', 'clavier', 'tastatur', 'imprimante', 'drucker', 'serveur', 'server', 'dell', 'hp', 'lenovo', 'apple'] },
  'Nettoyage':   { fr: ['Nettoyage', 'Entretien', 'Hygiène'], de: ['Reinigung', 'Unterhalt', 'Hygiene'], en: ['Cleaning', 'Maintenance', 'Hygiene'], keywords: ['nettoyage', 'reinigung', 'entretien', 'unterhalt', 'conciergerie', 'hauswart', 'hygiène'] },
  'Autre':       { fr: ['Autre', 'Divers'], de: ['Sonstiges', 'Andere', 'Diverses'], en: ['Other', 'Miscellaneous'], keywords: [] },
};
